    ...
    <div className="modal-backdrop">
      <form className="modal" role="dialog" aria-modal="true" onSubmit={submit}>
        ...
        <div className="form-grid">
          ...
          <label>Choke type<input value={chokeType} onChange={(event) => setChokeType(event.target.value)} placeholder="e.g. Multi-choke" /></label>
      ...
      <div className="form-grid">
        {type === "edit" ? (
          <>
            ...
            <label>
              Choke type
              <input value={chokeType} onChange={(event) => setChokeType(event.target.value)} placeholder="e.g. Multi-choke" />
            </label>
            <label>
              Barrel length
